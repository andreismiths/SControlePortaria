...
-- -----------------------------------------------------
-- Table `SControlePortaria`.`Professor`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SControlePortaria`.`Professor` (
  `PK_professor` INT NOT NULL AUTO_INCREMENT,
  `FK_funcionario` INT NULL,
  PRIMARY KEY (`PK_professor`),
  INDEX `fk_Professor_Funcionario1_idx` (`FK_funcionario` ASC),
...
CREATE TABLE IF NOT EXISTS `SControlePortaria`.`Portaria` (
  ...
  PRIMARY KEY (`PK_portaria`, `FK_professor`),
  INDEX `fk_Portaria_Professor1_idx` (`FK_professor` ASC),
  CONSTRAINT `fk_Portaria_Professor1`
    FOREIGN KEY (`FK_professor`)
    REFERENCES `SControlePortaria`.`Professor` (`PK_professor`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
