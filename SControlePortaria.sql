...
CREATE TABLE IF NOT EXISTS `SControlePortaria`.`Funcionario` (
  ...
  `siapeFuncionario` VARCHAR(8) NULL,
...
CREATE TABLE IF NOT EXISTS `SControlePortaria`.`Portaria` (
  ...
  PRIMARY KEY (`PK_portaria`, `FK_funcionario`),
  INDEX `fk_Portaria_Funcionario_idx` (`FK_funcionario` ASC),
  CONSTRAINT `fk_Portaria_Funcionario`
