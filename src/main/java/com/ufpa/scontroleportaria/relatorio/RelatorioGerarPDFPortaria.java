 ...
 * @author Ramon
 */
public class RelatorioGerarPDFPortaria {
    ...
    public RelatorioGerarPDFPortaria() {
    ...
    public void getRelatorio(List<Portaria> lista){
        ...
        try {
            ...
            */
            ...
            Logger.getLogger(RelatorioGerarPDFPortaria.class.getName()).log(Level.SEVERE, null, ex);
